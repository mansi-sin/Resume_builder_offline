...
import { User, Mail, Phone, Link, GraduationCap, Wrench, FolderGit2, Plus, Trash2, Award, BookOpen } from 'lucide-react';
    ...
    <div className="mb-4">
      ...
      <div className="relative group">
        ...
        <input
          ...
          maxLength={maxLength}
          className={`focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm rounded-xl py-3 border outline-none transition-all duration-300 ${
            darkMode 
    ...
    <div className={`${formBg} p-6 sm:p-8 rounded-3xl border transition-all duration-500`}>
      ...
      <div className="mb-8 pb-8 border-b border-slate-200 dark:border-slate-800">
        <h2 className={`text-2xl font-bold flex items-center gap-3 mb-6 ${headingText}`}>
          <span className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-2.5 rounded-xl shadow-lg shadow-blue-500/30">
            <User size={22} />
          </span>
          Personal Details
        </h2>
      ...
      <div className="mb-10">
        <div className="flex justify-between items-center mb-6">
          <h2 className={`text-xl font-bold flex items-center gap-3 ${headingText}`}>
            <span className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white p-2.5 rounded-xl shadow-lg shadow-indigo-500/30">
          ...
          {resumeData.education.length < 2 && (
            <button 
              ...
              className="flex items-center gap-1.5 text-sm bg-indigo-50 hover:bg-indigo-100 text-indigo-600 dark:bg-indigo-500/10 dark:hover:bg-indigo-500/20 dark:text-indigo-400 py-2 px-4 rounded-lg font-medium transition-colors border border-indigo-200 dark:border-indigo-500/20"
            >
      ...
      <div className="mb-10">
        <h2 className={`text-xl font-bold flex items-center gap-3 mb-6 ${headingText}`}>
          <span className="bg-gradient-to-br from-teal-500 to-teal-600 text-white p-2.5 rounded-xl shadow-lg shadow-teal-500/30">
            <Wrench size={22} />
          </span>
          Skills
        </h2>
      ...
      <div className="mb-10">
        <h2 className={`text-xl font-bold flex items-center gap-3 mb-6 ${headingText}`}>
          <span className="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-2.5 rounded-xl shadow-lg shadow-purple-500/30">
            <BookOpen size={22} />
          </span>
          Relevant Coursework
        </h2>
      ...
      <div className="mb-10">
        <div className="flex justify-between items-center mb-6">
          <h2 className={`text-xl font-bold flex items-center gap-3 ${headingText}`}>
            <span className="bg-gradient-to-br from-rose-500 to-rose-600 text-white p-2.5 rounded-xl shadow-lg shadow-rose-500/30">
              <FolderGit2 size={22} />
            </span>
            Projects & Experience
          </h2>
          <button 
            ...
            className="flex items-center gap-1.5 text-sm bg-rose-50 hover:bg-rose-100 text-rose-600 dark:bg-rose-500/10 dark:hover:bg-rose-500/20 dark:text-rose-400 py-2 px-4 rounded-lg font-medium transition-colors border border-rose-200 dark:border-rose-500/20"
          >
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className={`text-xl font-bold flex items-center gap-3 ${headingText}`}>
            <span className="bg-gradient-to-br from-amber-500 to-amber-600 text-white p-2.5 rounded-xl shadow-lg shadow-amber-500/30">
              <Award size={22} />
            </span>
            Certifications
          </h2>
          <button 
            ...
            className="flex items-center gap-1.5 text-sm bg-amber-50 hover:bg-amber-100 text-amber-700 dark:bg-amber-500/10 dark:hover:bg-amber-500/20 dark:text-amber-400 py-2 px-4 rounded-lg font-medium transition-colors border border-amber-200 dark:border-amber-500/20"
          >
